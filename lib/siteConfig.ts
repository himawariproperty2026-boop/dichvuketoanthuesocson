  ...
  pricingPackages: [
    {
      id: "co-ban",
      name: "Gói Cơ Bản",
      target: "Dành cho Hộ kinh doanh / Công ty ít hóa đơn (Dưới 10 hóa đơn/tháng)",
      price: "500.000", // TODO: Giá tạm
      period: "đ / tháng",
      recommended: false,
      features: [
        "Kê khai thuế GTGT, TNCN hàng quý",
        "Lập báo cáo tình hình sử dụng hóa đơn",
        "Tạm tính thuế TNDN quý",
        "Lập Báo cáo tài chính năm",
        "Tư vấn thuế qua Zalo/Điện thoại",
        "Chịu trách nhiệm giải trình số liệu kê khai"
      ],
    },
    {
      id: "chuyen-nghiep",
      name: "Gói Chuyên Nghiệp",
      target: "Dành cho Doanh nghiệp vừa (10 - 50 hóa đơn/tháng)",
      price: "1.000.000", // TODO: Giá tạm
      period: "đ / tháng",
      recommended: true,
      badge: "Phổ biến nhất",
      features: [
        "Tất cả quyền lợi của Gói Cơ Bản",
        "Xử lý từ 10 - 50 hóa đơn/tháng",
        "Lập sổ sách kế toán chi tiết (Thu, chi, kho, TSCĐ)",
        "Báo cáo quản trị doanh nghiệp định kỳ",
        "Cân đối doanh thu - chi phí tối ưu thuế",
        "Hỗ trợ giao nhận hồ sơ tận nơi Sóc Sơn",
        "Trực tiếp tiếp đoàn kiểm tra thuế"
      ],
    },
    {
      id: "doanh-nghiep",
      name: "Gói Doanh Nghiệp Lớn",
      target: "Dành cho Công ty thương mại, sản xuất, KCN (> 50 hóa đơn/tháng)",
      price: "2.000.000", // TODO: Giá tạm
      period: "đ / tháng",
      recommended: false,
      features: [
        "Tất cả quyền lợi của Gói Chuyên Nghiệp",
        "Không giới hạn số lượng hóa đơn chứng từ",
        "Tính giá thành sản phẩm / Công trình xây dựng",
        "Tư vấn chuyên sâu tối ưu chi phí & thuế TNDN",
        "Kế toán trưởng riêng phụ trách hồ sơ",
        "Bảo vệ 100% khi thanh tra thuế quyết toán",
        "Miễn phí 01 lần dịch vụ thay đổi ĐKKD/năm"
      ],
    },
  ],
