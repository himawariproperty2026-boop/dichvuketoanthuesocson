...
export const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
      {/* TopBar Header - Non-overlapping & Single Line Layout */}
      <div className="bg-slate-100 border-b border-slate-200 text-xs text-slate-700 py-1.5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            <a
              href={`tel:${siteConfig.contact.phone.replace(/\s+/g, "")}`}
              className="flex items-center gap-1.5 font-extrabold text-[#D7181F] hover:underline text-xs sm:text-sm shrink-0 whitespace-nowrap"
            >
              <Phone className="w-3.5 h-3.5 shrink-0" />
              <span>Hotline 24/7: {siteConfig.contact.phoneDisplay}</span>
            </a>
            <div className="hidden lg:flex items-center gap-1.5 text-slate-600 min-w-0 truncate">
              <MapPin className="w-3.5 h-3.5 text-[#04266F] shrink-0" />
              <span className="truncate">VP: {siteConfig.contact.address}</span>
            </div>
          </div>

          <div className="flex items-center gap-3 text-xs font-semibold shrink-0">
            <span className="hidden md:inline text-slate-500 whitespace-nowrap">
            ...
            <a
              ...
              className="px-2.5 py-1 rounded-full bg-blue-600 text-white font-extrabold text-[11px] hover:bg-blue-700 transition-colors flex items-center gap-1 shrink-0 whitespace-nowrap"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 sm:h-20 gap-2 sm:gap-4">
          {/* Brand Logo Mobile & Desktop Scaled */}
          <Link href="/" className="flex items-center gap-2 sm:gap-3 group shrink-0 min-w-0">
            <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-[#D7181F] text-white flex items-center justify-center font-black text-lg sm:text-xl shadow-md group-hover:scale-105 transition-transform shrink-0">
              <ShieldCheck className="w-5 h-5 sm:w-7 sm:h-7" />
            </div>
            <div className="flex flex-col min-w-0">
              <span className="font-black text-xs sm:text-sm md:text-base lg:text-lg tracking-tight text-[#04266F] leading-tight whitespace-nowrap truncate sm:whitespace-normal">
                KẾ TOÁN THUẾ <span className="text-[#D7181F]">MINH HOÁ</span> - SÓC SƠN HÀ NỘI
              </span>
              <span className="text-[9px] sm:text-[10px] lg:text-[11px] font-semibold text-slate-500 tracking-wider uppercase whitespace-nowrap">
          ...
          <nav className="hidden lg:flex items-center gap-0.5 xl:gap-1 shrink-0">
            <Link
              href="/"
              className={`px-2 xl:px-3 py-2 rounded-lg text-xs xl:text-sm font-bold transition-colors whitespace-nowrap ${
                pathname === "/"
            ...
            >
              <Link
                href="/dich-vu"
                className={`px-2 xl:px-3 py-2 rounded-lg text-xs xl:text-sm font-bold flex items-center gap-1 transition-colors whitespace-nowrap ${
          ...
          <div className="hidden lg:flex items-center gap-3 shrink-0">
            <Link
              href="/lien-he"
              className="px-3.5 xl:px-5 py-2.5 rounded-xl bg-[#D7181F] hover:bg-[#B81117] text-white font-extrabold text-xs tracking-wide shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 whitespace-nowrap"
            >
