            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-[1.15] text-[#131313]">
                  ...
                  <span className="text-[#D7181F]">UY TÍN </span>
                  <span className="text-[#04266F]">TẠI SÓC SƠN HÀ NỘI</span>
                </h1>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-3 pt-2">
                  <div className="p-2.5 sm:p-3.5 rounded-2xl bg-white border border-slate-200 shadow-soft text-center space-y-0.5 sm:space-y-1">
                    <div className="text-[#D7181F] font-black text-xs sm:text-base">Tối Ưu 80%</div>
                    <div className="text-[9px] sm:text-[11px] text-slate-600 font-semibold line-clamp-1">Chi phí kế toán</div>
                  </div>
                  <div className="p-2.5 sm:p-3.5 rounded-2xl bg-white border border-slate-200 shadow-soft text-center space-y-0.5 sm:space-y-1">
                    <div className="text-[#04266F] font-black text-xs sm:text-base">Cam Kết 100%</div>
                    <div className="text-[9px] sm:text-[11px] text-slate-600 font-semibold line-clamp-1">Trách nhiệm HĐ</div>
                  </div>
                  <div className="p-2.5 sm:p-3.5 rounded-2xl bg-white border border-slate-200 shadow-soft text-center space-y-0.5 sm:space-y-1">
                    <div className="text-[#D7181F] font-black text-xs sm:text-base">Hỗ Trợ 24/7</div>
                    <div className="text-[9px] sm:text-[11px] text-slate-600 font-semibold line-clamp-1">Zalo & Phone</div>
                  </div>
                </div>

                {/* Primary & Secondary Action Buttons - Stacked on Mobile */}
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2 sm:pt-4">
                  <Link
                    href="/lien-he"
                    className="w-full sm:w-auto px-7 py-3.5 sm:py-4 rounded-2xl bg-[#D7181F] hover:bg-[#B81117] text-white font-extrabold text-xs sm:text-base shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                  >
              ...
              <div className="lg:col-span-5 relative">
                <div className="rounded-3xl overflow-hidden bg-white border border-slate-200 p-3 shadow-2xl relative">
                  ...
                  <div className="absolute bottom-3 sm:bottom-6 left-2.5 sm:left-6 right-2.5 sm:right-6 p-2.5 sm:p-4 rounded-2xl bg-white/95 backdrop-blur-md border border-slate-200 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-1.5 sm:gap-2 text-center sm:text-left">
                    <div className="flex items-center justify-center sm:justify-start gap-1.5 sm:gap-2 min-w-0">
                      <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#D7181F] animate-pulse shrink-0" />
                      <div className="text-[11px] sm:text-sm font-black text-[#04266F] uppercase tracking-wide whitespace-nowrap">
