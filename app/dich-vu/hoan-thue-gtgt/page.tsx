...
export const metadata = {
  title: "Dịch Vụ Hoàn Thuế GTGT tại Sóc Sơn - Giải Ngân Nhanh Chuẩn Xác",
  description:
    "Tư vấn & lập hồ sơ hoàn thuế GTGT trọn gói cho doanh nghiệp xuất khẩu, dự án đầu tư tại các KCN Sóc Sơn, Mê Linh, Đông Anh.",
};
    ...
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800">
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-4">
                <span className="px-3 py-1 rounded-md bg-amber-500/20 text-amber-300 text-xs font-bold border border-amber-500/30">
                  Chi phí: {service.priceStarting}
                </span>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight">
                  Dịch Vụ Hoàn Thuế GTGT Tại Sóc Sơn & KCN
                </h1>
              ...
              <div className="lg:col-span-4 bg-slate-900 p-6 rounded-2xl border border-amber-500/30 text-center space-y-3">
                ...
                <h3 className="text-xl font-bold text-white">Giải Ngân Chuẩn Xác</h3>
                <p className="text-xs text-slate-300">
                  Kiểm tra tính hợp lệ hóa đơn chứng từ đầu vào nghiêm ngặt trước khi nộp.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="dang-ky-tuvan" className="py-16 bg-slate-950 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionHeading subtitle="Tư vấn hoàn thuế" title="Đăng Ký Tư Vấn Hoàn Thuế GTGT" dark />
            <div className="mt-10">
              <ContactFormSection />
            </div>
          </div>
