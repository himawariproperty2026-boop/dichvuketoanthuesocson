...
export const metadata = {
  ...
  description:
    "Tư vấn cấu trúc chi phí doanh nghiệp, lập kế hoạch thuế dài hạn, quản trị rủi ro hóa đơn và chuyển đổi hộ kinh doanh lên công ty tại Sóc Sơn.",
};
    ...
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800">
      ...
      <main className="flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-4">
                <span className="px-3 py-1 rounded-md bg-amber-500/20 text-amber-300 text-xs font-bold border border-amber-500/30">
                  Phí tư vấn từ: {service.priceStarting}
                </span>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight">
                  Tư Vấn Thuế & Kế Toán Chuyên Sâu Sóc Sơn
                </h1>
              ...
              <div className="lg:col-span-4 bg-slate-900 p-6 rounded-2xl border border-amber-500/30 text-center space-y-3">
                ...
                <h3 className="text-xl font-bold text-white">Hoạch Định Thuế</h3>
                <p className="text-xs text-slate-300">
                  Tư vấn giải pháp rủi ro hóa đơn & cấu trúc chi phí dòng tiền hợp pháp.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="dang-ky-tuvan" className="py-16 bg-slate-950 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <SectionHeading subtitle="Tư vấn chuyên sâu" title="Đăng Ký Tư Vấn Thuế Cùng Chuyên Gia" dark />
            <div className="mt-10">
              <ContactFormSection />
            </div>
          </div>
